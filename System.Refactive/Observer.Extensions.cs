...
namespace System.Refactive
{
    ...
    public static class Observer
    {
        ...
        public static IRefObserver<T> ToObserver<T>(this Action<Notification<T>> handler)
        {
            if (handler == null)
            {
            ...
            return new AnonymousObserver<T>(
                (ref T x) => handler(Notification.CreateOnNext(x)),
        ...
        public static Action<Notification<T>> ToNotifier<T>(this IRefObserver<T> observer)
        {
            if (observer == null)
            {
        ...
        public static IRefObserver<T> Create<T>(RefAction<T> onNext)
        {
            if (onNext == null)
            {
        ...
        public static IRefObserver<T> Create<T>(RefAction<T> onNext, Action<Exception> onError)
        {
            if (onNext == null)
            {
                throw new ArgumentNullException(nameof(onNext));
        ...
        public static IRefObserver<T> Create<T>(RefAction<T> onNext, Action onCompleted)
        {
            if (onNext == null)
            {
                throw new ArgumentNullException(nameof(onNext));
        ...
        public static IRefObserver<T> Create<T>(RefAction<T> onNext, Action<Exception> onError, Action onCompleted)
        {
            if (onNext == null)
            {
                throw new ArgumentNullException(nameof(onNext));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="observer"/> is null.</exception>
        public static IRefObserver<T> AsObserver<T>(this IRefObserver<T> observer)
        {
            if (observer == null)
            {
                throw new ArgumentNullException(nameof(observer));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="observer"/> is null.</exception>
        public static IRefObserver<T> Checked<T>(this IRefObserver<T> observer)
        {
            if (observer == null)
            {
                throw new ArgumentNullException(nameof(observer));
        ...
        /// well, use the <see cref="Synchronize{T}(IRefObserver{T}, bool)"/> overload, passing true for the second parameter.
        /// </remarks>
        public static IRefObserver<T> Synchronize<T>(IRefObserver<T> observer)
        {
            if (observer == null)
            {
                throw new ArgumentNullException(nameof(observer));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="observer"/> is null.</exception>
        /// <remarks>
        /// When the <paramref name="preventReentrancy"/> parameter is set to false, behavior is identical to the <see cref="Synchronize{T}(IRefObserver{T})"/> overload which uses
        ...
        /// </remarks>
        public static IRefObserver<T> Synchronize<T>(IRefObserver<T> observer, bool preventReentrancy)
        {
            if (observer == null)
            {
                throw new ArgumentNullException(nameof(observer));
        ...
        /// Because a <see cref="Monitor">Monitor</see> is used to perform the synchronization, there's no protection against reentrancy from the same thread.
        /// Hence, overlapped observer callbacks are still possible, which is invalid behavior according to the observer grammar. In order to protect against this behavior as
        /// well, use the <see cref="Synchronize{T}(IRefObserver{T}, AsyncLock)"/> overload.
        /// </remarks>
        public static IRefObserver<T> Synchronize<T>(IRefObserver<T> observer, object gate)
        {
            if (observer == null)
            {
                throw new ArgumentNullException(nameof(observer));
        ...
        public static IRefObserver<T> Synchronize<T>(IRefObserver<T> observer, AsyncLock asyncLock)
        {
            if (observer == null)
            {
                throw new ArgumentNullException(nameof(observer));
        ...
        public static IRefObserver<T> NotifyOn<T>(this IRefObserver<T> observer, IScheduler scheduler)
        {
            if (observer == null)
            {
                throw new ArgumentNullException(nameof(observer));
        ...
        public static IRefObserver<T> NotifyOn<T>(this IRefObserver<T> observer, SynchronizationContext context)
        {
            if (observer == null)
            {
                throw new ArgumentNullException(nameof(observer));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="observer"/> is null.</exception>
        public static IProgress<T> ToProgress<T>(this IRefObserver<T> observer)
        {
            if (observer == null)
            {
                throw new ArgumentNullException(nameof(observer));
        ...
        /// <returns>Progress object whose Report messages correspond to the observer's OnNext messages.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="observer"/> or <paramref name="scheduler"/> is null.</exception>
        public static IProgress<T> ToProgress<T>(this IRefObserver<T> observer, IScheduler scheduler)
        {
            if (observer == null)
            {
                throw new ArgumentNullException(nameof(observer));
        ...
        {
            private readonly RefAction<T> _progress;

            public AnonymousProgress(RefAction<T> progress)
            {
                _progress = progress;
            }
        ...
        public static IRefObserver<T> ToObserver<T>(this IProgress<T> progress)
        {
            if (progress == null)
            {
            ...
            return new AnonymousObserver<T>((ref T x) => progress.Report(x));
        }
    }
}
