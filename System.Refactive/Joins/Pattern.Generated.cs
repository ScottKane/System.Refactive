...
namespace System.Refactive.Joins
{
    ...
    {
        internal Pattern(IRefObservable<TSource1> first)
        {
            First = first;
        }

        internal IRefObservable<TSource1> First { get; }
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second)
        {
            First = first;
            Second = second;
        }
        ...
        internal IRefObservable<TSource1> First { get; }
        internal IRefObservable<TSource2> Second { get; }
        ...
        public Pattern<TSource1, TSource2, TSource3> And<TSource3>(IRefObservable<TSource3> other)
        {
            if (other == null)
            {
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource1> First { get; }
        internal IRefObservable<TSource2> Second { get; }
        internal IRefObservable<TSource3> Third { get; }
        ...
        /// <returns>Pattern object that matches when all observable sequences have an available element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="other"/> is null.</exception>
        public Pattern<TSource1, TSource2, TSource3, TSource4> And<TSource4>(IRefObservable<TSource4> other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third, IRefObservable<TSource4> fourth)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource2> Second { get; }
        internal IRefObservable<TSource3> Third { get; }
        internal IRefObservable<TSource4> Fourth { get; }
        ...
        /// <returns>Pattern object that matches when all observable sequences have an available element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="other"/> is null.</exception>
        public Pattern<TSource1, TSource2, TSource3, TSource4, TSource5> And<TSource5>(IRefObservable<TSource5> other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third, IRefObservable<TSource4> fourth, IRefObservable<TSource5> fifth)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource3> Third { get; }
        internal IRefObservable<TSource4> Fourth { get; }
        internal IRefObservable<TSource5> Fifth { get; }
        ...
        /// <returns>Pattern object that matches when all observable sequences have an available element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="other"/> is null.</exception>
        public Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6> And<TSource6>(IRefObservable<TSource6> other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third, IRefObservable<TSource4> fourth, IRefObservable<TSource5> fifth, IRefObservable<TSource6> sixth)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource4> Fourth { get; }
        internal IRefObservable<TSource5> Fifth { get; }
        internal IRefObservable<TSource6> Sixth { get; }
        ...
        /// <returns>Pattern object that matches when all observable sequences have an available element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="other"/> is null.</exception>
        public Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7> And<TSource7>(IRefObservable<TSource7> other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third, IRefObservable<TSource4> fourth, IRefObservable<TSource5> fifth, IRefObservable<TSource6> sixth, IRefObservable<TSource7> seventh)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource5> Fifth { get; }
        internal IRefObservable<TSource6> Sixth { get; }
        internal IRefObservable<TSource7> Seventh { get; }
        ...
        /// <returns>Pattern object that matches when all observable sequences have an available element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="other"/> is null.</exception>
        public Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TSource8> And<TSource8>(IRefObservable<TSource8> other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third, IRefObservable<TSource4> fourth, IRefObservable<TSource5> fifth, IRefObservable<TSource6> sixth, IRefObservable<TSource7> seventh, IRefObservable<TSource8> eighth)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource6> Sixth { get; }
        internal IRefObservable<TSource7> Seventh { get; }
        internal IRefObservable<TSource8> Eighth { get; }
        ...
        /// <returns>Pattern object that matches when all observable sequences have an available element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="other"/> is null.</exception>
        public Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TSource8, TSource9> And<TSource9>(IRefObservable<TSource9> other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third, IRefObservable<TSource4> fourth, IRefObservable<TSource5> fifth, IRefObservable<TSource6> sixth, IRefObservable<TSource7> seventh, IRefObservable<TSource8> eighth, IRefObservable<TSource9> ninth)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource7> Seventh { get; }
        internal IRefObservable<TSource8> Eighth { get; }
        internal IRefObservable<TSource9> Ninth { get; }
        ...
        /// <returns>Pattern object that matches when all observable sequences have an available element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="other"/> is null.</exception>
        public Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TSource8, TSource9, TSource10> And<TSource10>(IRefObservable<TSource10> other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third, IRefObservable<TSource4> fourth, IRefObservable<TSource5> fifth, IRefObservable<TSource6> sixth, IRefObservable<TSource7> seventh, IRefObservable<TSource8> eighth, IRefObservable<TSource9> ninth, IRefObservable<TSource10> tenth)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource8> Eighth { get; }
        internal IRefObservable<TSource9> Ninth { get; }
        internal IRefObservable<TSource10> Tenth { get; }
        ...
        /// <returns>Pattern object that matches when all observable sequences have an available element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="other"/> is null.</exception>
        public Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TSource8, TSource9, TSource10, TSource11> And<TSource11>(IRefObservable<TSource11> other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third, IRefObservable<TSource4> fourth, IRefObservable<TSource5> fifth, IRefObservable<TSource6> sixth, IRefObservable<TSource7> seventh, IRefObservable<TSource8> eighth, IRefObservable<TSource9> ninth, IRefObservable<TSource10> tenth, IRefObservable<TSource11> eleventh)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource9> Ninth { get; }
        internal IRefObservable<TSource10> Tenth { get; }
        internal IRefObservable<TSource11> Eleventh { get; }
        ...
        /// <returns>Pattern object that matches when all observable sequences have an available element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="other"/> is null.</exception>
        public Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TSource8, TSource9, TSource10, TSource11, TSource12> And<TSource12>(IRefObservable<TSource12> other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third, IRefObservable<TSource4> fourth, IRefObservable<TSource5> fifth, IRefObservable<TSource6> sixth, IRefObservable<TSource7> seventh, IRefObservable<TSource8> eighth, IRefObservable<TSource9> ninth, IRefObservable<TSource10> tenth, IRefObservable<TSource11> eleventh, IRefObservable<TSource12> twelfth)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource10> Tenth { get; }
        internal IRefObservable<TSource11> Eleventh { get; }
        internal IRefObservable<TSource12> Twelfth { get; }
        ...
        /// <returns>Pattern object that matches when all observable sequences have an available element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="other"/> is null.</exception>
        public Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TSource8, TSource9, TSource10, TSource11, TSource12, TSource13> And<TSource13>(IRefObservable<TSource13> other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third, IRefObservable<TSource4> fourth, IRefObservable<TSource5> fifth, IRefObservable<TSource6> sixth, IRefObservable<TSource7> seventh, IRefObservable<TSource8> eighth, IRefObservable<TSource9> ninth, IRefObservable<TSource10> tenth, IRefObservable<TSource11> eleventh, IRefObservable<TSource12> twelfth, IRefObservable<TSource13> thirteenth)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource11> Eleventh { get; }
        internal IRefObservable<TSource12> Twelfth { get; }
        internal IRefObservable<TSource13> Thirteenth { get; }
        ...
        /// <returns>Pattern object that matches when all observable sequences have an available element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="other"/> is null.</exception>
        public Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TSource8, TSource9, TSource10, TSource11, TSource12, TSource13, TSource14> And<TSource14>(IRefObservable<TSource14> other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third, IRefObservable<TSource4> fourth, IRefObservable<TSource5> fifth, IRefObservable<TSource6> sixth, IRefObservable<TSource7> seventh, IRefObservable<TSource8> eighth, IRefObservable<TSource9> ninth, IRefObservable<TSource10> tenth, IRefObservable<TSource11> eleventh, IRefObservable<TSource12> twelfth, IRefObservable<TSource13> thirteenth, IRefObservable<TSource14> fourteenth)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource12> Twelfth { get; }
        internal IRefObservable<TSource13> Thirteenth { get; }
        internal IRefObservable<TSource14> Fourteenth { get; }
        ...
        /// <returns>Pattern object that matches when all observable sequences have an available element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="other"/> is null.</exception>
        public Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TSource8, TSource9, TSource10, TSource11, TSource12, TSource13, TSource14, TSource15> And<TSource15>(IRefObservable<TSource15> other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third, IRefObservable<TSource4> fourth, IRefObservable<TSource5> fifth, IRefObservable<TSource6> sixth, IRefObservable<TSource7> seventh, IRefObservable<TSource8> eighth, IRefObservable<TSource9> ninth, IRefObservable<TSource10> tenth, IRefObservable<TSource11> eleventh, IRefObservable<TSource12> twelfth, IRefObservable<TSource13> thirteenth, IRefObservable<TSource14> fourteenth, IRefObservable<TSource15> fifteenth)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource13> Thirteenth { get; }
        internal IRefObservable<TSource14> Fourteenth { get; }
        internal IRefObservable<TSource15> Fifteenth { get; }
        ...
        /// <returns>Pattern object that matches when all observable sequences have an available element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="other"/> is null.</exception>
        public Pattern<TSource1, TSource2, TSource3, TSource4, TSource5, TSource6, TSource7, TSource8, TSource9, TSource10, TSource11, TSource12, TSource13, TSource14, TSource15, TSource16> And<TSource16>(IRefObservable<TSource16> other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
    ...
    {
        internal Pattern(IRefObservable<TSource1> first, IRefObservable<TSource2> second, IRefObservable<TSource3> third, IRefObservable<TSource4> fourth, IRefObservable<TSource5> fifth, IRefObservable<TSource6> sixth, IRefObservable<TSource7> seventh, IRefObservable<TSource8> eighth, IRefObservable<TSource9> ninth, IRefObservable<TSource10> tenth, IRefObservable<TSource11> eleventh, IRefObservable<TSource12> twelfth, IRefObservable<TSource13> thirteenth, IRefObservable<TSource14> fourteenth, IRefObservable<TSource15> fifteenth, IRefObservable<TSource16> sixteenth)
        {
            First = first;
            Second = second;
            Third = third;
        ...
        internal IRefObservable<TSource14> Fourteenth { get; }
        internal IRefObservable<TSource15> Fifteenth { get; }
        internal IRefObservable<TSource16> Sixteenth { get; }
