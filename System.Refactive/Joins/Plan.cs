...
namespace System.Refactive.Joins
{
    /// <summary>
    ...
    public abstract class Plan<TResult>
    {
        ...
        internal abstract ActivePlan Activate(Dictionary<object, IJoinObserver> externalSubscriptions,
                                              IRefObserver<TResult> observer, Action<ActivePlan> deactivate);

        internal static JoinObserver<TSource> CreateObserver<TSource>(
            Dictionary<object, IJoinObserver> externalSubscriptions, IRefObservable<TSource> observable, Action<Exception> onError)
        {
