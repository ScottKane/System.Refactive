...
namespace System.Refactive.Concurrency
{
    ...
    public static class Synchronization
    {
        ...
        /// In order to invoke observer callbacks on the specified scheduler, e.g. to offload callback processing to a dedicated thread, use <see cref="Synchronization.ObserveOn{TSource}(IRefObservable{TSource}, IScheduler)"/>.
        /// </remarks>
        public static IRefObservable<TSource> SubscribeOn<TSource>(IRefObservable<TSource> source, IScheduler scheduler)
        {
            if (source == null)
            {
        ...
        private sealed class SubscribeOnObservable<TSource> : ObservableBase<TSource>
        {
            private sealed class Subscription : IDisposable
            {
                ...
                public Subscription(IRefObservable<TSource> source, IScheduler scheduler, IRefObserver<TSource> observer)
                {
                    _cancel.TrySetFirst(
                        scheduler.Schedule(
            ...
            public SubscribeOnObservable(IRefObservable<TSource> source, IScheduler scheduler)
            {
                _source = source;
        ...
        /// In order to invoke observer callbacks on the specified synchronization context, e.g. to post callbacks to a UI thread represented by the synchronization context, use <see cref="Synchronization.ObserveOn{TSource}(IRefObservable{TSource}, SynchronizationContext)"/>.
        /// </remarks>
        public static IRefObservable<TSource> SubscribeOn<TSource>(IRefObservable<TSource> source, SynchronizationContext context)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        private sealed class SubscribeOnCtxObservable<TSource> : ObservableBase<TSource>
        {
            private sealed class Subscription : IDisposable
            {
                ...
                public Subscription(IRefObservable<TSource> source, SynchronizationContext context, IRefObserver<TSource> observer)
                {
                    _source = source;
                    _context = context;
                    _observer = observer;
            ...
            public SubscribeOnCtxObservable(IRefObservable<TSource> source, SynchronizationContext context)
            {
                _source = source;
                _context = context;
            }
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="scheduler"/> is <c>null</c>.</exception>
        public static IRefObservable<TSource> ObserveOn<TSource>(IRefObservable<TSource> source, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="context"/> is <c>null</c>.</exception>
        public static IRefObservable<TSource> ObserveOn<TSource>(IRefObservable<TSource> source, SynchronizationContext context)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TSource> Synchronize<TSource>(IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TSource> Synchronize<TSource>(IRefObservable<TSource> source, object gate)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
