...
namespace System.Refactive.Concurrency
{
    ...
    internal sealed class /*Default*/ConcurrencyAbstractionLayerImpl : IConcurrencyAbstractionLayer
    {
        ...
        public IDisposable StartTimer(RefAction<object?> action, object? state, TimeSpan dueTime) => new Timer(action, state, Normalize(dueTime));
        ...
        private sealed class Timer : IDisposable
        {
            ...
            public void Dispose()
            {
                ...
                _action = Stubs<object?>.RefIgnore;
