...
namespace System.Refactive.Subjects
{
    ...
    public sealed class BehaviorSubject<T> : SubjectBase<T>
    {
        ...
        private ImmutableList<IRefObserver<T>> _observers;
        ...
        {
            _value = value;
            _observers = ImmutableList<IRefObserver<T>>.Empty;
        }
        ...
        private void Unsubscribe(IRefObserver<T> observer)
        {
            lock (_gate)
            {
                if (!_isDisposed)
        ...
        private sealed class Subscription : IDisposable
        {
            ...
            private IRefObserver<T>? _observer;

            public Subscription(BehaviorSubject<T> subject, IRefObserver<T> observer)
            {
                _subject = subject;
                _observer = observer;
            }
