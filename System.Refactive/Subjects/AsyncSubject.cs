...
namespace System.Refactive.Subjects
{
    ...
    public sealed class AsyncSubject<T> : SubjectBase<T>, INotifyCompletion
    {
        ...
        /// <summary>
        /// A disposable connecting the AsyncSubject and an IRefObserver.
        /// </summary>
        private sealed class AsyncSubjectDisposable : IDisposable
        {
            ...
            public AsyncSubjectDisposable(AsyncSubject<T> subject, IRefObserver<T> observer)
            {
                _subject = subject;
                _observer = observer;
            }

            public IRefObserver<T>? Observer => _observer;
        ...
        private sealed class AwaitObserver : IRefObserver<T>
        {
        ...
        private sealed class BlockingObserver : IRefObserver<T>
        {
