...
{
    /// <summary>
    /// Abstract base class for implementations of the <see cref="IRefObservable{T}"/> interface.
    /// </summary>
    /// <remarks>
    ...
    public abstract class ObservableBase<T> : IRefObservable<T>
    {
        /// <summary>
        ...
        /// <returns>Disposable object representing an observer's subscription to the observable sequence.</returns>
        protected abstract IDisposable SubscribeCore(IRefObserver<T> observer);
    }
}
