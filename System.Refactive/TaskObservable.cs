...
using System.Refactive.Runtime.CompilerServices;
using System.Runtime.CompilerServices;

namespace System.Refactive
{
    /// <summary>
    /// Extension of the <see cref="IRefObservable{T}"/> interface compatible with async method return types.
    /// </summary>
    /// <remarks>
    ...
    public interface ITaskObservable<T> : IRefObservable<T>
    {
