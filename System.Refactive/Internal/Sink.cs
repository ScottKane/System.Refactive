...
{
    internal interface ISink<TTarget>
    {
        void ForwardOnNext(ref TTarget value);
    ...
    internal abstract class Sink<TTarget> : ISink<TTarget>, IDisposable
    {
        ...
        private volatile IRefObserver<TTarget> _observer;

        protected Sink(IRefObserver<TTarget> observer)
        {
            _observer = observer;
        }
        ...
        public void ForwardOnNext(ref TTarget value)
        {
    ...
    internal abstract class Sink<TSource, TTarget> : Sink<TTarget>, IRefObserver<TSource>
    {
        protected Sink(IRefObserver<TTarget> observer) : base(observer)
        {
        }

        public virtual void Run(IRefObservable<TSource> source)
        {
        ...
        public IRefObserver<TTarget> GetForwarder() => new _(this);

        private sealed class _ : IRefObserver<TTarget>
        {
            ...
            public void OnNext(ref TTarget value) => _forward.ForwardOnNext(ref value);
