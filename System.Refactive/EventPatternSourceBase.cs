...
namespace System.Refactive
{
    ...
    public abstract class EventPatternSourceBase<TSender, TEventArgs>
    {
        private sealed class Observer : ObserverBase<EventPattern<TSender, TEventArgs>>, ISafeObserver<EventPattern<TSender, TEventArgs>>
        {
            ...
            private readonly RefAction<TSender?, TEventArgs> _invoke;
            private readonly EventPatternSourceBase<TSender, TEventArgs> _sourceBase;

            public Observer(EventPatternSourceBase<TSender, TEventArgs> sourceBase, Delegate handler, RefAction<TSender?, TEventArgs> invoke)
            {
                _handler = handler;
                _invoke = invoke;
            ...
            protected override void OnNextCore(ref EventPattern<TSender, TEventArgs> value)
            {
        ...
        private readonly IRefObservable<EventPattern<TSender, TEventArgs>> _source;
        private readonly Dictionary<Delegate, Stack<IDisposable>> _subscriptions;
        private readonly Action<RefAction<TSender?, TEventArgs>, /*object,*/ EventPattern<TSender, TEventArgs>> _invokeHandler;
        ...
        protected EventPatternSourceBase(IRefObservable<EventPattern<TSender, TEventArgs>> source, Action<RefAction<TSender?, TEventArgs>, /*object,*/ EventPattern<TSender, TEventArgs>> invokeHandler)
        {
        ...
        protected void Add(Delegate handler, RefAction<TSender?, TEventArgs> invoke)
        {
            if (handler == null)
            {
