...
namespace System.Refactive
{
    ...
    public static class ObservableExtensions
    {
        ...
        public static IDisposable Subscribe<T>(this IRefObservable<T> source)
        {
            if (source == null)
            {
            ...
            //
            return source.Subscribe/*Unsafe*/(new AnonymousObserver<T>(Stubs<T>.RefIgnore, Stubs.Throw, Stubs.Nop));
        }
        ...
        public static IDisposable Subscribe<T>(this IRefObservable<T> source, RefAction<T> onNext, Action<Exception> onError)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IDisposable Subscribe<T>(this IRefObservable<T> source, RefAction<T> onNext, Action onCompleted)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IDisposable Subscribe<T>(this IRefObservable<T> source, RefAction<T> onNext, Action<Exception> onError, Action onCompleted)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static void Subscribe<T>(this IRefObservable<T> source, IRefObserver<T> observer, CancellationToken token)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <param name="token">CancellationToken that can be signaled to unsubscribe from the source sequence.</param>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <c>null</c>.</exception>
        public static void Subscribe<T>(this IRefObservable<T> source, CancellationToken token)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
            ...
            source.Subscribe_(new AnonymousObserver<T>(Stubs<T>.RefIgnore, Stubs.Throw, Stubs.Nop), token);
        }
        ...
        /// <param name="token">CancellationToken that can be signaled to unsubscribe from the source sequence.</param>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="onNext"/> is <c>null</c>.</exception>
        public static void Subscribe<T>(this IRefObservable<T> source, RefAction<T> onNext, CancellationToken token)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <param name="token">CancellationToken that can be signaled to unsubscribe from the source sequence.</param>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="onNext"/> or <paramref name="onError"/> is <c>null</c>.</exception>
        public static void Subscribe<T>(this IRefObservable<T> source, RefAction<T> onNext, Action<Exception> onError, CancellationToken token)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <param name="token">CancellationToken that can be signaled to unsubscribe from the source sequence.</param>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="onNext"/> or <paramref name="onCompleted"/> is <c>null</c>.</exception>
        public static void Subscribe<T>(this IRefObservable<T> source, RefAction<T> onNext, Action onCompleted, CancellationToken token)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <param name="token">CancellationToken that can be signaled to unsubscribe from the source sequence.</param>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="onNext"/> or <paramref name="onError"/> or <paramref name="onCompleted"/> is <c>null</c>.</exception>
        public static void Subscribe<T>(this IRefObservable<T> source, RefAction<T> onNext, Action<Exception> onError, Action onCompleted, CancellationToken token)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        private static void Subscribe_<T>(this IRefObservable<T> source, IRefObserver<T> observer, CancellationToken token)
        {
        ...
        /// <summary>
        /// Subscribes to the specified source, re-routing synchronous exceptions during invocation of the <see cref="IRefObservable{T}.Subscribe(IRefObserver{T})"/> method to the observer's <see cref="IRefObserver{T}.OnError(Exception)"/> channel.
        ...
        public static IDisposable SubscribeSafe<T>(this IRefObservable<T> source, IRefObserver<T> observer)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
