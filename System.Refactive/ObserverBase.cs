...
{
    /// <summary>
    /// Abstract base class for implementations of the <see cref="IRefObserver{T}"/> interface.
    /// </summary>
    /// <remarks>This base class enforces the grammar of observers where <see cref="IRefObserver{T}.OnError(Exception)"/> and <see cref="IRefObserver{T}.OnCompleted()"/> are terminal messages.</remarks>
    /// <typeparam name="T">The type of the elements in the sequence.</typeparam>
    public abstract class ObserverBase<T> : IRefObserver<T>, IDisposable
    {
        ...
        [Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1716:IdentifiersShouldNotMatchKeywords", MessageId = "Error", Justification = "Same name as in the IRefObserver<T> definition of OnError in the BCL.")]
