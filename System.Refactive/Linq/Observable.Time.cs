...
namespace System.Refactive.Linq
{
    public static partial class Observable
    {
        ...
        /// </remarks>
        public static IRefObservable<IList<TSource>> Buffer<TSource>(this IRefObservable<TSource> source, TimeSpan timeSpan)
        {
            if (source == null)
            {
        ...
        /// by the scheduler, where the action to close the current buffer and to create a new buffer may not execute immediately, despite the TimeSpan.Zero due time.
        /// </remarks>
        public static IRefObservable<IList<TSource>> Buffer<TSource>(this IRefObservable<TSource> source, TimeSpan timeSpan, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<IList<TSource>> Buffer<TSource>(this IRefObservable<TSource> source, TimeSpan timeSpan, TimeSpan timeShift)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<IList<TSource>> Buffer<TSource>(this IRefObservable<TSource> source, TimeSpan timeSpan, TimeSpan timeShift, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// by the scheduler, where the action to close the current buffer and to create a new buffer may not execute immediately, despite the TimeSpan.Zero due time.
        /// </remarks>
        public static IRefObservable<IList<TSource>> Buffer<TSource>(this IRefObservable<TSource> source, TimeSpan timeSpan, int count)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// by the scheduler, where the action to close the current buffer and to create a new buffer may not execute immediately, despite the TimeSpan.Zero due time.
        /// </remarks>
        public static IRefObservable<IList<TSource>> Buffer<TSource>(this IRefObservable<TSource> source, TimeSpan timeSpan, int count, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>
        /// <para>
        /// This operator is less efficient than <see cref="Observable.DelaySubscription{T}(IRefObservable{T}, TimeSpan)">DelaySubscription</see> because it records all notifications and time-delays those. This allows for immediate propagation of errors.
        /// </para>
        /// <para>
        ...
        /// In order to delay error propagation, consider using the <see cref="Materialize">Observable.Materialize</see> and <see cref="Dematerialize">Observable.Dematerialize</see> operators, or use <see cref="Observable.DelaySubscription{T}(IRefObservable{T}, TimeSpan)">DelaySubscription</see>.
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> Delay<TSource>(this IRefObservable<TSource> source, TimeSpan dueTime)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>
        /// <para>
        /// This operator is less efficient than <see cref="Observable.DelaySubscription{T}(IRefObservable{T}, TimeSpan, IScheduler)">DelaySubscription</see> because it records all notifications and time-delays those. This allows for immediate propagation of errors.
        /// </para>
        /// <para>
        ...
        /// <para>
        /// Exceptions signaled by the source sequence through an OnError callback are forwarded immediately to the result sequence. Any OnNext notifications that were in the queue at the point of the OnError callback will be dropped.
        /// In order to delay error propagation, consider using the <see cref="Materialize">Observable.Materialize</see> and <see cref="Dematerialize">Observable.Dematerialize</see> operators, or use <see cref="Observable.DelaySubscription{T}(IRefObservable{T}, TimeSpan, IScheduler)">DelaySubscription</see>.
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> Delay<TSource>(this IRefObservable<TSource> source, TimeSpan dueTime, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>
        /// <para>
        /// This operator is less efficient than <see cref="Observable.DelaySubscription{T}(IRefObservable{T}, DateTimeOffset)">DelaySubscription</see> because it records all notifications and time-delays those. This allows for immediate propagation of errors.
        /// </para>
        /// <para>
        /// Observer callbacks for the resulting sequence will be run on the default scheduler. This effect is similar to using ObserveOn.
        /// </para>
        /// <para>
        /// Exceptions signaled by the source sequence through an OnError callback are forwarded immediately to the result sequence. Any OnNext notifications that were in the queue at the point of the OnError callback will be dropped.
        /// In order to delay error propagation, consider using the <see cref="Materialize">Observable.Materialize</see> and <see cref="Dematerialize">Observable.Dematerialize</see> operators, or use <see cref="Observable.DelaySubscription{T}(IRefObservable{T}, DateTimeOffset)">DelaySubscription</see>.
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> Delay<TSource>(this IRefObservable<TSource> source, DateTimeOffset dueTime)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>
        /// <para>
        /// This operator is less efficient than <see cref="Observable.DelaySubscription{T}(IRefObservable{T}, DateTimeOffset, IScheduler)">DelaySubscription</see> because it records all notifications and time-delays those. This allows for immediate propagation of errors.
        /// </para>
        /// <para>
        /// Observer callbacks for the resulting sequence will be run on the specified scheduler. This effect is similar to using ObserveOn.
        /// </para>
        /// <para>
        /// Exceptions signaled by the source sequence through an OnError callback are forwarded immediately to the result sequence. Any OnNext notifications that were in the queue at the point of the OnError callback will be dropped.
        /// In order to delay error propagation, consider using the <see cref="Materialize">Observable.Materialize</see> and <see cref="Dematerialize">Observable.Dematerialize</see> operators, or use <see cref="Observable.DelaySubscription{T}(IRefObservable{T}, DateTimeOffset, IScheduler)">DelaySubscription</see>.
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> Delay<TSource>(this IRefObservable<TSource> source, DateTimeOffset dueTime, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TSource> Delay<TSource, TDelay>(this IRefObservable<TSource> source, Func<TSource, IRefObservable<TDelay>> delayDurationSelector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TSource> Delay<TSource, TDelay>(this IRefObservable<TSource> source, IRefObservable<TDelay> subscriptionDelay, Func<TSource, IRefObservable<TDelay>> delayDurationSelector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>
        /// <para>
        /// This operator is more efficient than <see cref="Observable.Delay{T}(IRefObservable{T}, TimeSpan)">Delay</see> but postpones all side-effects of subscription and affects error propagation timing.
        /// </para>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> DelaySubscription<TSource>(this IRefObservable<TSource> source, TimeSpan dueTime)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>
        /// <para>
        /// This operator is more efficient than <see cref="Observable.Delay{T}(IRefObservable{T}, TimeSpan, IScheduler)">Delay</see> but postpones all side-effects of subscription and affects error propagation timing.
        /// </para>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> DelaySubscription<TSource>(this IRefObservable<TSource> source, TimeSpan dueTime, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>
        /// <para>
        /// This operator is more efficient than <see cref="Observable.Delay{T}(IRefObservable{T}, DateTimeOffset)">Delay</see> but postpones all side-effects of subscription and affects error propagation timing.
        /// </para>
        /// <para>
        /// The side-effects of subscribing to the source sequence will be run on the default scheduler. Observer callbacks will not be affected.
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> DelaySubscription<TSource>(this IRefObservable<TSource> source, DateTimeOffset dueTime)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>
        /// <para>
        /// This operator is more efficient than <see cref="Observable.Delay{T}(IRefObservable{T}, DateTimeOffset, IScheduler)">Delay</see> but postpones all side-effects of subscription and affects error propagation timing.
        /// </para>
        /// <para>
        /// The side-effects of subscribing to the source sequence will be run on the specified scheduler. Observer callbacks will not be affected.
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> DelaySubscription<TSource>(this IRefObservable<TSource> source, DateTimeOffset dueTime, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TResult> Generate<TState, TResult>(TState initialState, Func<TState, bool> condition, Func<TState, TState> iterate, Func<TState, TResult> resultSelector, Func<TState, TimeSpan> timeSelector)
        {
            if (condition == null)
            {
        ...
        public static IRefObservable<TResult> Generate<TState, TResult>(TState initialState, Func<TState, bool> condition, Func<TState, TState> iterate, Func<TState, TResult> resultSelector, Func<TState, TimeSpan> timeSelector, IScheduler scheduler)
        {
            if (condition == null)
            {
                throw new ArgumentNullException(nameof(condition));
        ...
        /// <returns>The generated sequence.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="condition"/> or <paramref name="iterate"/> or <paramref name="resultSelector"/> or <paramref name="timeSelector"/> is null.</exception>
        public static IRefObservable<TResult> Generate<TState, TResult>(TState initialState, Func<TState, bool> condition, Func<TState, TState> iterate, Func<TState, TResult> resultSelector, Func<TState, DateTimeOffset> timeSelector)
        {
            if (condition == null)
            {
                throw new ArgumentNullException(nameof(condition));
        ...
        /// <returns>The generated sequence.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="condition"/> or <paramref name="iterate"/> or <paramref name="resultSelector"/> or <paramref name="timeSelector"/> or <paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<TResult> Generate<TState, TResult>(TState initialState, Func<TState, bool> condition, Func<TState, TState> iterate, Func<TState, TResult> resultSelector, Func<TState, DateTimeOffset> timeSelector, IScheduler scheduler)
        {
            if (condition == null)
            {
                throw new ArgumentNullException(nameof(condition));
        ...
        /// operator instead.
        /// </remarks>
        public static IRefObservable<long> Interval(TimeSpan period)
        {
        ...
        /// operator instead.
        /// </remarks>
        public static IRefObservable<long> Interval(TimeSpan period, IScheduler scheduler)
        {
            if (period < TimeSpan.Zero)
            {
                throw new ArgumentOutOfRangeException(nameof(period));
        ...
        /// </remarks>
        public static IRefObservable<TSource> Sample<TSource>(this IRefObservable<TSource> source, TimeSpan interval)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// of the asynchrony introduced by the scheduler, where the sampling action may not execute immediately, despite the TimeSpan.Zero due time.
        /// </remarks>
        public static IRefObservable<TSource> Sample<TSource>(this IRefObservable<TSource> source, TimeSpan interval, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TSource> Sample<TSource, TSample>(this IRefObservable<TSource> source, IRefObservable<TSample> sampler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> Skip<TSource>(this IRefObservable<TSource> source, TimeSpan duration)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> Skip<TSource>(this IRefObservable<TSource> source, TimeSpan duration, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </remarks>
        public static IRefObservable<TSource> SkipLast<TSource>(this IRefObservable<TSource> source, TimeSpan duration)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// result sequence. This causes elements to be delayed with <paramref name="duration"/>.
        /// </remarks>
        public static IRefObservable<TSource> SkipLast<TSource>(this IRefObservable<TSource> source, TimeSpan duration, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </remarks>
        public static IRefObservable<TSource> SkipUntil<TSource>(this IRefObservable<TSource> source, DateTimeOffset startTime)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// Errors produced by the source sequence are always forwarded to the result sequence, even if the error occurs before the <paramref name="startTime"/>.
        /// </remarks>
        public static IRefObservable<TSource> SkipUntil<TSource>(this IRefObservable<TSource> source, DateTimeOffset startTime, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </remarks>
        public static IRefObservable<TSource> Take<TSource>(this IRefObservable<TSource> source, TimeSpan duration)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// immediately, despite the TimeSpan.Zero due time.
        /// </remarks>
        public static IRefObservable<TSource> Take<TSource>(this IRefObservable<TSource> source, TimeSpan duration, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </remarks>
        public static IRefObservable<TSource> TakeLast<TSource>(this IRefObservable<TSource> source, TimeSpan duration)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// to be delayed with <paramref name="duration"/>.
        /// </remarks>
        public static IRefObservable<TSource> TakeLast<TSource>(this IRefObservable<TSource> source, TimeSpan duration, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// to be delayed with <paramref name="duration"/>.
        /// </remarks>
        public static IRefObservable<TSource> TakeLast<TSource>(this IRefObservable<TSource> source, TimeSpan duration, IScheduler timerScheduler, IScheduler loopScheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </remarks>
        public static IRefObservable<IList<TSource>> TakeLastBuffer<TSource>(this IRefObservable<TSource> source, TimeSpan duration)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// the source sequence. Upon completion of the source sequence, this buffer is produced on the result sequence.
        /// </remarks>
        public static IRefObservable<IList<TSource>> TakeLastBuffer<TSource>(this IRefObservable<TSource> source, TimeSpan duration, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        public static IRefObservable<TSource> TakeUntil<TSource>(this IRefObservable<TSource> source, DateTimeOffset endTime)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <returns>An observable sequence with the elements taken until the specified end time.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<TSource> TakeUntil<TSource>(this IRefObservable<TSource> source, DateTimeOffset endTime, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> Throttle<TSource>(this IRefObservable<TSource> source, TimeSpan dueTime)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> Throttle<TSource>(this IRefObservable<TSource> source, TimeSpan dueTime, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </remarks>
        public static IRefObservable<TSource> Throttle<TSource, TThrottle>(this IRefObservable<TSource> source, Func<TSource, IRefObservable<TThrottle>> throttleDurationSelector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        public static IRefObservable<Refactive.TimeInterval<TSource>> TimeInterval<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <returns>An observable sequence with time interval information on elements.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<Refactive.TimeInterval<TSource>> TimeInterval<TSource>(this IRefObservable<TSource> source, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>
        /// <para>
        /// In case you only want to timeout on the first element, consider using the <see cref="Observable.Amb{TSource}(IRefObservable{TSource}, IRefObservable{TSource})"/>
        ...
        /// of Timeout, <see cref="Timeout{TSource, TTimeout}(IRefObservable{TSource}, IRefObservable{TTimeout}, Func{TSource, IRefObservable{TTimeout}})"/> can be used.
        /// </para>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> Timeout<TSource>(this IRefObservable<TSource> source, TimeSpan dueTime)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> Timeout<TSource>(this IRefObservable<TSource> source, TimeSpan dueTime, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> Timeout<TSource>(this IRefObservable<TSource> source, TimeSpan dueTime, IRefObservable<TSource> other)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<TSource> Timeout<TSource>(this IRefObservable<TSource> source, TimeSpan dueTime, IRefObservable<TSource> other, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// of Timeout, <see cref="Timeout{TSource, TTimeout}(IRefObservable{TSource}, IRefObservable{TTimeout}, Func{TSource, IRefObservable{TTimeout}})"/> can be used.
        /// </remarks>
        public static IRefObservable<TSource> Timeout<TSource>(this IRefObservable<TSource> source, DateTimeOffset dueTime)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// of Timeout, <see cref="Timeout{TSource, TTimeout}(IRefObservable{TSource}, IRefObservable{TTimeout}, Func{TSource, IRefObservable{TTimeout}})"/> can be used.
        /// </remarks>
        public static IRefObservable<TSource> Timeout<TSource>(this IRefObservable<TSource> source, DateTimeOffset dueTime, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// of Timeout, <see cref="Timeout{TSource, TTimeout}(IRefObservable{TSource}, IRefObservable{TTimeout}, Func{TSource, IRefObservable{TTimeout}})"/> can be used.
        /// </remarks>
        public static IRefObservable<TSource> Timeout<TSource>(this IRefObservable<TSource> source, DateTimeOffset dueTime, IRefObservable<TSource> other)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// of Timeout, <see cref="Timeout{TSource, TTimeout}(IRefObservable{TSource}, IRefObservable{TTimeout}, Func{TSource, IRefObservable{TTimeout}})"/> can be used.
        /// </remarks>
        public static IRefObservable<TSource> Timeout<TSource>(this IRefObservable<TSource> source, DateTimeOffset dueTime, IRefObservable<TSource> other, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TSource> Timeout<TSource, TTimeout>(this IRefObservable<TSource> source, Func<TSource, IRefObservable<TTimeout>> timeoutDurationSelector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TSource> Timeout<TSource, TTimeout>(this IRefObservable<TSource> source, Func<TSource, IRefObservable<TTimeout>> timeoutDurationSelector, IRefObservable<TSource> other)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TSource> Timeout<TSource, TTimeout>(this IRefObservable<TSource> source, IRefObservable<TTimeout> firstTimeout, Func<TSource, IRefObservable<TTimeout>> timeoutDurationSelector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TSource> Timeout<TSource, TTimeout>(this IRefObservable<TSource> source, IRefObservable<TTimeout> firstTimeout, Func<TSource, IRefObservable<TTimeout>> timeoutDurationSelector, IRefObservable<TSource> other)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<long> Timer(TimeSpan dueTime)
        {
        ...
        public static IRefObservable<long> Timer(DateTimeOffset dueTime)
        {
            return s_impl.Timer(dueTime);
        }
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="period"/> is less than TimeSpan.Zero.</exception>
        public static IRefObservable<long> Timer(TimeSpan dueTime, TimeSpan period)
        {
            if (period < TimeSpan.Zero)
            {
                throw new ArgumentOutOfRangeException(nameof(period));
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="period"/> is less than TimeSpan.Zero.</exception>
        public static IRefObservable<long> Timer(DateTimeOffset dueTime, TimeSpan period)
        {
            if (period < TimeSpan.Zero)
            {
                throw new ArgumentOutOfRangeException(nameof(period));
        ...
        /// <returns>An observable sequence that produces a value after the due time has elapsed.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<long> Timer(TimeSpan dueTime, IScheduler scheduler)
        {
            if (scheduler == null)
            {
                throw new ArgumentNullException(nameof(scheduler));
        ...
        /// <returns>An observable sequence that produces a value at due time.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<long> Timer(DateTimeOffset dueTime, IScheduler scheduler)
        {
            if (scheduler == null)
            {
                throw new ArgumentNullException(nameof(scheduler));
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="period"/> is less than TimeSpan.Zero.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<long> Timer(TimeSpan dueTime, TimeSpan period, IScheduler scheduler)
        {
            if (period < TimeSpan.Zero)
            {
                throw new ArgumentOutOfRangeException(nameof(period));
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="period"/> is less than TimeSpan.Zero.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<long> Timer(DateTimeOffset dueTime, TimeSpan period, IScheduler scheduler)
        {
            if (period < TimeSpan.Zero)
            {
                throw new ArgumentOutOfRangeException(nameof(period));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        public static IRefObservable<Timestamped<TSource>> Timestamp<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <returns>An observable sequence with timestamp information on elements.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<Timestamped<TSource>> Timestamp<TSource>(this IRefObservable<TSource> source, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </remarks>
        public static IRefObservable<IRefObservable<TSource>> Window<TSource>(this IRefObservable<TSource> source, TimeSpan timeSpan)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// by the scheduler, where the action to close the current window and to create a new window may not execute immediately, despite the TimeSpan.Zero due time.
        /// </remarks>
        public static IRefObservable<IRefObservable<TSource>> Window<TSource>(this IRefObservable<TSource> source, TimeSpan timeSpan, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<IRefObservable<TSource>> Window<TSource>(this IRefObservable<TSource> source, TimeSpan timeSpan, TimeSpan timeShift)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </para>
        /// </remarks>
        public static IRefObservable<IRefObservable<TSource>> Window<TSource>(this IRefObservable<TSource> source, TimeSpan timeSpan, TimeSpan timeShift, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// by the scheduler, where the action to close the current window and to create a new window may not execute immediately, despite the TimeSpan.Zero due time.
        /// </remarks>
        public static IRefObservable<IRefObservable<TSource>> Window<TSource>(this IRefObservable<TSource> source, TimeSpan timeSpan, int count)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// by the scheduler, where the action to close the current window and to create a new window may not execute immediately, despite the TimeSpan.Zero due time.
        /// </remarks>
        public static IRefObservable<IRefObservable<TSource>> Window<TSource>(this IRefObservable<TSource> source, TimeSpan timeSpan, int count, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
