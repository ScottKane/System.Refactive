...
namespace System.Refactive.Linq
{
    public static partial class Observable
    {
        ...
        public static IConnectableObservable<TResult> Multicast<TSource, TResult>(this IRefObservable<TSource> source, ISubject<TSource, TResult> subject)
        {
            if (source == null)
            {
        ...
        public static IRefObservable<TResult> Multicast<TSource, TIntermediate, TResult>(this IRefObservable<TSource> source, Func<ISubject<TSource, TIntermediate>> subjectSelector, Func<IRefObservable<TIntermediate>, IRefObservable<TResult>> selector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IConnectableObservable<TSource> Publish<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <seealso cref="Subject{T}"/>
        public static IRefObservable<TResult> Publish<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, IRefObservable<TResult>> selector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IConnectableObservable<TSource> Publish<TSource>(this IRefObservable<TSource> source, TSource initialValue)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="selector"/> is null.</exception>
        /// <seealso cref="BehaviorSubject{T}"/>
        public static IRefObservable<TResult> Publish<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, IRefObservable<TResult>> selector, TSource initialValue)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IConnectableObservable<TSource> PublishLast<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="selector"/> is null.</exception>
        /// <seealso cref="AsyncSubject{T}"/>
        public static IRefObservable<TResult> PublishLast<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, IRefObservable<TResult>> selector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        public static IRefObservable<TSource> RefCount<TSource>(this IConnectableObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <returns>An observable sequence that stays connected to the source as long as there is at least one subscription to the observable sequence.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        public static IRefObservable<TSource> RefCount<TSource>(this IConnectableObservable<TSource> source, TimeSpan disconnectDelay)
        {
            if (source == null)
            {
        ...
        /// <returns>An observable sequence that stays connected to the source as long as there is at least one subscription to the observable sequence.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        public static IRefObservable<TSource> RefCount<TSource>(this IConnectableObservable<TSource> source, TimeSpan disconnectDelay, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException("source");
        ...
        public static IRefObservable<TSource> RefCount<TSource>(this IConnectableObservable<TSource> source, int minObservers)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="minObservers"/> is non-positive.</exception>
        public static IRefObservable<TSource> RefCount<TSource>(this IConnectableObservable<TSource> source, int minObservers, TimeSpan disconnectDelay)
        {
            if (source == null)
            {
                throw new ArgumentNullException("source");
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="minObservers"/> is non-positive.</exception>
        public static IRefObservable<TSource> RefCount<TSource>(this IConnectableObservable<TSource> source, int minObservers, TimeSpan disconnectDelay, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException("source");
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        public static IRefObservable<TSource> AutoConnect<TSource>(this IConnectableObservable<TSource> source, int minObservers = 1, Action<IDisposable>? onConnect = null)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IConnectableObservable<TSource> Replay<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>Subscribers will receive all the notifications of the source.</remarks>
        /// <seealso cref="ReplaySubject{T}"/>
        public static IConnectableObservable<TSource> Replay<TSource>(this IRefObservable<TSource> source, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="selector"/> is null.</exception>
        /// <seealso cref="ReplaySubject{T}"/>
        public static IRefObservable<TResult> Replay<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, IRefObservable<TResult>> selector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <seealso cref="ReplaySubject{T}"/>
        public static IRefObservable<TResult> Replay<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, IRefObservable<TResult>> selector, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <seealso cref="ReplaySubject{T}"/>
        public static IConnectableObservable<TSource> Replay<TSource>(this IRefObservable<TSource> source, TimeSpan window)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="window"/> is less than TimeSpan.Zero.</exception>
        /// <seealso cref="ReplaySubject{T}"/>
        public static IRefObservable<TResult> Replay<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, IRefObservable<TResult>> selector, TimeSpan window)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>Subscribers will receive all the notifications of the source subject to the specified replay buffer trimming policy.</remarks>
        /// <seealso cref="ReplaySubject{T}"/>
        public static IConnectableObservable<TSource> Replay<TSource>(this IRefObservable<TSource> source, TimeSpan window, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="window"/> is less than TimeSpan.Zero.</exception>
        /// <seealso cref="ReplaySubject{T}"/>
        public static IRefObservable<TResult> Replay<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, IRefObservable<TResult>> selector, TimeSpan window, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>Subscribers will receive all the notifications of the source subject to the specified replay buffer trimming policy.</remarks>
        /// <seealso cref="ReplaySubject{T}"/>
        public static IConnectableObservable<TSource> Replay<TSource>(this IRefObservable<TSource> source, int bufferSize, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="bufferSize"/> is less than zero.</exception>
        /// <seealso cref="ReplaySubject{T}"/>
        public static IRefObservable<TResult> Replay<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, IRefObservable<TResult>> selector, int bufferSize, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>Subscribers will receive all the notifications of the source subject to the specified replay buffer trimming policy.</remarks>
        /// <seealso cref="ReplaySubject{T}"/>
        public static IConnectableObservable<TSource> Replay<TSource>(this IRefObservable<TSource> source, int bufferSize)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="bufferSize"/> is less than zero.</exception>
        /// <seealso cref="ReplaySubject{T}"/>
        public static IRefObservable<TResult> Replay<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, IRefObservable<TResult>> selector, int bufferSize)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>Subscribers will receive all the notifications of the source subject to the specified replay buffer trimming policy.</remarks>
        /// <seealso cref="ReplaySubject{T}"/>
        public static IConnectableObservable<TSource> Replay<TSource>(this IRefObservable<TSource> source, int bufferSize, TimeSpan window)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="window"/> is less than TimeSpan.Zero.</exception>
        /// <seealso cref="ReplaySubject{T}"/>
        public static IRefObservable<TResult> Replay<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, IRefObservable<TResult>> selector, int bufferSize, TimeSpan window)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>Subscribers will receive all the notifications of the source subject to the specified replay buffer trimming policy.</remarks>
        /// <seealso cref="ReplaySubject{T}"/>
        public static IConnectableObservable<TSource> Replay<TSource>(this IRefObservable<TSource> source, int bufferSize, TimeSpan window, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="window"/> is less than TimeSpan.Zero.</exception>
        /// <seealso cref="ReplaySubject{T}"/>
        public static IRefObservable<TResult> Replay<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, IRefObservable<TResult>> selector, int bufferSize, TimeSpan window, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
