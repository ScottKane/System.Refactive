...
namespace System.Refactive.Linq
{
    public static partial class Observable
    {
        ...
        /// that require to be run on a scheduler, use <see cref="Observable.SubscribeOn{TSource}(IRefObservable{TSource}, IScheduler)"/>.
        /// </remarks>
        public static IRefObservable<TSource> ObserveOn<TSource>(this IRefObservable<TSource> source, IScheduler scheduler)
        {
            if (source == null)
            {
        ...
        /// that require to be run on a synchronization context, use <see cref="Observable.SubscribeOn{TSource}(IRefObservable{TSource}, SynchronizationContext)"/>.
        /// </remarks>
        public static IRefObservable<TSource> ObserveOn<TSource>(this IRefObservable<TSource> source, SynchronizationContext context)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// callbacks on a scheduler, use <see cref="Observable.ObserveOn{TSource}(IRefObservable{TSource}, IScheduler)"/>.
        /// </remarks>
        public static IRefObservable<TSource> SubscribeOn<TSource>(this IRefObservable<TSource> source, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// callbacks on a synchronization context, use <see cref="Observable.ObserveOn{TSource}(IRefObservable{TSource}, SynchronizationContext)"/>.
        /// </remarks>
        public static IRefObservable<TSource> SubscribeOn<TSource>(this IRefObservable<TSource> source, SynchronizationContext context)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </remarks>
        public static IRefObservable<TSource> Synchronize<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TSource> Synchronize<TSource>(this IRefObservable<TSource> source, object gate)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
