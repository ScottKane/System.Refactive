...
namespace System.Refactive.Linq
{
    public static partial class Observable
    {
        ...
        public static AsyncSubject<TSource> GetAwaiter<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
        ...
        /// <returns>Object that can be awaited.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        public static AsyncSubject<TSource> RunAsync<TSource>(this IRefObservable<TSource> source, CancellationToken cancellationToken)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
