...
namespace System.Refactive.Linq
{
    public static partial class Observable
    {
        ...
        /// <remarks>
        /// Use of this operator is preferred over manual implementation of the <see cref="IRefObservable{T}"/> interface. In case
        /// you need a type implementing <see cref="IRefObservable{T}"/> rather than an anonymous implementation, consider using
        /// the <see cref="ObservableBase{T}"/> abstract base class.
        /// </remarks>
        public static IRefObservable<TResult> Create<TResult>(Func<IRefObserver<TResult>, IDisposable> subscribe)
        {
            if (subscribe == null)
            {
        ...
        /// the <see cref="ObservableBase{T}"/> abstract base class.
        /// </remarks>
        public static IRefObservable<TResult> Create<TResult>(Func<IRefObserver<TResult>, Action> subscribe)
        {
            if (subscribe == null)
            {
                throw new ArgumentNullException(nameof(subscribe));
        ...
        public static IRefObservable<TResult> Create<TResult>(Func<IRefObserver<TResult>, CancellationToken, Task> subscribeAsync)
        {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="subscribeAsync"/> is null.</exception>
        /// <remarks>This operator is especially useful in conjunction with the asynchronous programming features introduced in C# 5.0 and Visual Basic 11.</remarks>
        public static IRefObservable<TResult> Create<TResult>(Func<IRefObserver<TResult>, Task> subscribeAsync)
        {
            if (subscribeAsync == null)
            {
                throw new ArgumentNullException(nameof(subscribeAsync));
        ...
        /// <remarks>This operator is especially useful in conjunction with the asynchronous programming features introduced in C# 5.0 and Visual Basic 11.</remarks>
        /// <remarks>When a subscription to the resulting sequence is disposed, the CancellationToken that was fed to the asynchronous subscribe function will be signaled.</remarks>
        public static IRefObservable<TResult> Create<TResult>(Func<IRefObserver<TResult>, CancellationToken, Task<IDisposable>> subscribeAsync)
        {
            if (subscribeAsync == null)
            {
                throw new ArgumentNullException(nameof(subscribeAsync));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="subscribeAsync"/> is null.</exception>
        /// <remarks>This operator is especially useful in conjunction with the asynchronous programming features introduced in C# 5.0 and Visual Basic 11.</remarks>
        public static IRefObservable<TResult> Create<TResult>(Func<IRefObserver<TResult>, Task<IDisposable>> subscribeAsync)
        {
            if (subscribeAsync == null)
            {
                throw new ArgumentNullException(nameof(subscribeAsync));
        ...
        /// <remarks>This operator is especially useful in conjunction with the asynchronous programming features introduced in C# 5.0 and Visual Basic 11.</remarks>
        /// <remarks>When a subscription to the resulting sequence is disposed, the CancellationToken that was fed to the asynchronous subscribe function will be signaled.</remarks>
        public static IRefObservable<TResult> Create<TResult>(Func<IRefObserver<TResult>, CancellationToken, Task<Action>> subscribeAsync)
        {
            if (subscribeAsync == null)
            {
                throw new ArgumentNullException(nameof(subscribeAsync));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="subscribeAsync"/> is null.</exception>
        /// <remarks>This operator is especially useful in conjunction with the asynchronous programming features introduced in C# 5.0 and Visual Basic 11.</remarks>
        public static IRefObservable<TResult> Create<TResult>(Func<IRefObserver<TResult>, Task<Action>> subscribeAsync)
        {
            if (subscribeAsync == null)
            {
                throw new ArgumentNullException(nameof(subscribeAsync));
        ...
        public static IRefObservable<TResult> Defer<TResult>(Func<IRefObservable<TResult>> observableFactory)
        {
        ...
        /// <remarks>This operator is especially useful in conjunction with the asynchronous programming features introduced in C# 5.0 and Visual Basic 11.</remarks>
        public static IRefObservable<TResult> Defer<TResult>(Func<Task<IRefObservable<TResult>>> observableFactoryAsync)
        {
        ...
        public static IRefObservable<TResult> DeferAsync<TResult>(Func<CancellationToken, Task<IRefObservable<TResult>>> observableFactoryAsync)
        {
            if (observableFactoryAsync == null)
            {
                throw new ArgumentNullException(nameof(observableFactoryAsync));
        ...
        /// </summary>
        /// <typeparam name="TResult">The type used for the <see cref="IRefObservable{T}"/> type parameter of the resulting sequence.</typeparam>
        /// <returns>An observable sequence with no elements.</returns>
        public static IRefObservable<TResult> Empty<TResult>()
        {
        ...
        /// <returns>An observable sequence with no elements.</returns>
        public static IRefObservable<TResult> Empty<TResult>(TResult witness)
        {
        ...
        public static IRefObservable<TResult> Empty<TResult>(IScheduler scheduler)
        {
            if (scheduler == null)
            {
        ...
        /// <returns>An observable sequence with no elements.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<TResult> Empty<TResult>(IScheduler scheduler, TResult witness)
        {
            if (scheduler == null)
            {
                throw new ArgumentNullException(nameof(scheduler));
        ...
        public static IRefObservable<TResult> Generate<TState, TResult>(TState initialState, Func<TState, bool> condition, Func<TState, TState> iterate, Func<TState, TResult> resultSelector)
        {
            if (condition == null)
            {
        ...
        public static IRefObservable<TResult> Generate<TState, TResult>(TState initialState, Func<TState, bool> condition, Func<TState, TState> iterate, Func<TState, TResult> resultSelector, IScheduler scheduler)
        {
            if (condition == null)
            {
                throw new ArgumentNullException(nameof(condition));
        ...
        public static IRefObservable<TResult> Never<TResult>()
        {
        ...
        /// <param name="witness">Object solely used to infer the type of the <typeparamref name="TResult"/> type parameter. This parameter is typically used when creating a sequence of anonymously typed elements.</param>
        /// <returns>An observable sequence whose observers will never get called.</returns>
        public static IRefObservable<TResult> Never<TResult>(TResult witness)
        {
        ...
        public static IRefObservable<int> Range(int start, int count)
        {
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="count"/> is less than zero. -or- <paramref name="start"/> + <paramref name="count"/> - 1 is larger than <see cref="int.MaxValue"/>.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<int> Range(int start, int count, IScheduler scheduler)
        {
            var max = (long)start + count - 1;
            if (count < 0 || max > int.MaxValue)
            {
        ...
        public static IRefObservable<TResult> Repeat<TResult>(TResult value)
        {
        ...
        /// <returns>An observable sequence that repeats the given element infinitely.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<TResult> Repeat<TResult>(TResult value, IScheduler scheduler)
        {
            if (scheduler == null)
            {
                throw new ArgumentNullException(nameof(scheduler));
        ...
        public static IRefObservable<TResult> Repeat<TResult>(TResult value, int repeatCount)
        {
            if (repeatCount < 0)
            {
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="repeatCount"/> is less than zero.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<TResult> Repeat<TResult>(TResult value, int repeatCount, IScheduler scheduler)
        {
            if (repeatCount < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(repeatCount));
        ...
        public static IRefObservable<TResult> Return<TResult>(TResult value)
        {
        ...
        /// <returns>An observable sequence containing the single specified element.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<TResult> Return<TResult>(TResult value, IScheduler scheduler)
        {
            if (scheduler == null)
            {
                throw new ArgumentNullException(nameof(scheduler));
        ...
        public static IRefObservable<TResult> Throw<TResult>(Exception exception)
        {
            if (exception == null)
            {
        ...
        /// <returns>The observable sequence that terminates exceptionally with the specified exception object.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="exception"/> is null.</exception>
        public static IRefObservable<TResult> Throw<TResult>(Exception exception, TResult witness)
        {
            if (exception == null)
            {
                throw new ArgumentNullException(nameof(exception));
        ...
        public static IRefObservable<TResult> Throw<TResult>(Exception exception, IScheduler scheduler)
        {
            if (exception == null)
            {
                throw new ArgumentNullException(nameof(exception));
        ...
        /// <returns>The observable sequence that terminates exceptionally with the specified exception object.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="exception"/> or <paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<TResult> Throw<TResult>(Exception exception, IScheduler scheduler, TResult witness)
        {
            if (exception == null)
            {
                throw new ArgumentNullException(nameof(exception));
        ...
        public static IRefObservable<TResult> Using<TResult, TResource>(Func<TResource> resourceFactory, Func<TResource, IRefObservable<TResult>> observableFactory) where TResource : IDisposable
        {
        ...
        public static IRefObservable<TResult> Using<TResult, TResource>(Func<CancellationToken, Task<TResource>> resourceFactoryAsync, Func<TResource, CancellationToken, Task<IRefObservable<TResult>>> observableFactoryAsync) where TResource : IDisposable
        {
