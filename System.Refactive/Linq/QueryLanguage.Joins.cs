...
namespace System.Refactive.Linq
{
    internal partial class QueryLanguage
    {
        ...
        public virtual Pattern<TLeft, TRight> And<TLeft, TRight>(IRefObservable<TLeft> left, IRefObservable<TRight> right)
        {
        ...
        public virtual Plan<TResult> Then<TSource, TResult>(IRefObservable<TSource> source, Func<TSource, TResult> selector)
        {
        ...
        public virtual IRefObservable<TResult> When<TResult>(params Plan<TResult>[] plans)
        {
            return When((IEnumerable<Plan<TResult>>)plans);
        }

        public virtual IRefObservable<TResult> When<TResult>(IEnumerable<Plan<TResult>> plans)
        {
        ...
        private sealed class WhenObservable<TResult> : ObservableBase<TResult>
        {
            ...
            private sealed class OutObserver : IRefObserver<TResult>
            {
                private readonly IRefObserver<TResult> _observer;
                private readonly Dictionary<object, IJoinObserver> _externalSubscriptions;

                public OutObserver(IRefObserver<TResult> observer, Dictionary<object, IJoinObserver> externalSubscriptions)
                {
                    _observer = observer;
                ...
                public void OnNext(ref TResult value)
                {
