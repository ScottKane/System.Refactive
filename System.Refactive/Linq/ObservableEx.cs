...
#pragma warning restore IDE1006 // Naming Styles
        ...
        [Experimental]
        public static IRefObservable<TResult> Create<TResult>(Func<IRefObserver<TResult>, IEnumerable<IRefObservable<object>>> iteratorMethod)
        {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="iteratorMethod"/> is null.</exception>
        [Experimental]
        public static IRefObservable<Unit> Create(Func<IEnumerable<IRefObservable<object>>> iteratorMethod)
        {
            if (iteratorMethod == null)
            {
                throw new ArgumentNullException(nameof(iteratorMethod));
        ...
        [Experimental]
        public static IRefObservable<TSource> Expand<TSource>(this IRefObservable<TSource> source, Func<TSource, IRefObservable<TSource>> selector, IScheduler scheduler)
        {
            if (source == null)
            {
        ...
        [Experimental]
        public static IRefObservable<TSource> Expand<TSource>(this IRefObservable<TSource> source, Func<TSource, IRefObservable<TSource>> selector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        [Experimental]
        public static IRefObservable<TResult> ForkJoin<TSource1, TSource2, TResult>(this IRefObservable<TSource1> first, IRefObservable<TSource2> second, Func<TSource1, TSource2, TResult> resultSelector)
        {
            if (first == null)
            {
        ...
        [Experimental]
        public static IRefObservable<TSource[]> ForkJoin<TSource>(params IRefObservable<TSource>[] sources)
        {
            if (sources == null)
            {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        [Experimental]
        public static IRefObservable<TSource[]> ForkJoin<TSource>(this IEnumerable<IRefObservable<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="selector"/> is null.</exception>
        [Experimental]
        public static IRefObservable<TResult> Let<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, IRefObservable<TResult>> selector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </summary>
        [Experimental]
        public static IRefObservable<TResult> ManySelect<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, TResult> selector, IScheduler scheduler)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// </summary>
        [Experimental]
        public static IRefObservable<TResult> ManySelect<TSource, TResult>(this IRefObservable<TSource> source, Func<IRefObservable<TSource>, TResult> selector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        [Experimental]
        public static ListObservable<TSource> ToListObservable<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
