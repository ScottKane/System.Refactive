...
namespace System.Refactive.Linq
{
    internal static class Repeat<TResult>
    {
        ...
        internal sealed class CountRecursive : Producer<TResult, CountRecursive._>
        {
            ...
            protected override _ CreateSink(IRefObserver<TResult> observer) => new _(_value, _repeatCount, observer);
            ...
            internal sealed class _ : IdentitySink<TResult>
            {
                ...
                public _(TResult value, int repeatCount, IRefObserver<TResult> observer)
                    : base(observer)
                {
                    _value = value;
        ...
        internal sealed class CountLongRunning : Producer<TResult, CountLongRunning._>
        {
            ...
            internal sealed class _ : IdentitySink<TResult>
            {
                ...
                public _(TResult value, int remaining, IRefObserver<TResult> observer)
                    : base(observer)
                {
                    _value = value;
                    _remaining = remaining;
