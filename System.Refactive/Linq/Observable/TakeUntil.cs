...
namespace System.Refactive.Linq
{
    internal sealed class TakeUntil<TSource, TOther> : Producer<TSource, TakeUntil<TSource, TOther>._>
    {
        ...
        public TakeUntil(IRefObservable<TSource> source, IRefObservable<TOther> other)
        {
            _source = source;
            _other = other;
        }
        ...
        internal sealed class _ : IdentitySink<TSource>
        {
            ...
            private sealed class OtherObserver : IRefObserver<TOther>
            {
    ...
    internal sealed class TakeUntil<TSource> : Producer<TSource, TakeUntil<TSource>._>
    {
        ...
        public TakeUntil(IRefObservable<TSource> source, DateTimeOffset endTime, IScheduler scheduler)
        {
            _source = source;
            _endTime = endTime;
        ...
        public IRefObservable<TSource> Combine(DateTimeOffset endTime)
        {
            //
            // Minimum semantics:
            //
