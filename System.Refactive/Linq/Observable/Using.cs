...
namespace System.Refactive.Linq
{
        ...
        where TResource : IDisposable
    {
        ...
        private readonly Func<TResource, IRefObservable<TSource>> _observableFactory;

        public Using(Func<TResource> resourceFactory, Func<TResource, IRefObservable<TSource>> observableFactory)
        {
