...
namespace System.Refactive.Linq
{
    internal sealed class Aggregate<TSource> : Producer<TSource, Aggregate<TSource>._>
    {
        ...
        public Aggregate(IRefObservable<TSource> source, Func<TSource, TSource, TSource> accumulator)
        {
            _source = source;
        ...
        internal sealed class _ : IdentitySink<TSource>
        {
            ...
            public override void OnCompleted()
            {
                ...
                else
                {
                    ...
                    _accumulation = default;
                    ForwardOnNext(ref accumulation);
                    ForwardOnCompleted();
                }
            }
        }
    ...
    internal sealed class Aggregate<TSource, TAccumulate> : Producer<TAccumulate, Aggregate<TSource, TAccumulate>._>
    {
        ...
        public Aggregate(IRefObservable<TSource> source, TAccumulate seed, Func<TAccumulate, TSource, TAccumulate> accumulator)
        {
            _source = source;
            _seed = seed;
            _accumulator = accumulator;
        ...
        protected override _ CreateSink(IRefObserver<TAccumulate> observer) => new _(_seed, _accumulator, observer);
        ...
        internal sealed class _ : Sink<TSource, TAccumulate>
        {
            ...
            public _(TAccumulate seed, Func<TAccumulate, TSource, TAccumulate> accumulator, IRefObserver<TAccumulate> observer)
                : base(observer)
            {
                _accumulator = accumulator;
                _accumulation = seed;
    ...
    internal sealed class Aggregate<TSource, TAccumulate, TResult> : Producer<TResult, Aggregate<TSource, TAccumulate, TResult>._>
    {
        ...
        public Aggregate(IRefObservable<TSource> source, TAccumulate seed, Func<TAccumulate, TSource, TAccumulate> accumulator, Func<TAccumulate, TResult> resultSelector)
        {
            _source = source;
            _seed = seed;
            _accumulator = accumulator;
        ...
        internal sealed class _ : Sink<TSource, TResult>
        {
            ...
            public _(Aggregate<TSource, TAccumulate, TResult> parent, IRefObserver<TResult> observer)
                : base(observer)
            {
