...
namespace System.Refactive.Linq
{
    internal sealed class Join<TLeft, TRight, TLeftDuration, TRightDuration, TResult> : Producer<TResult, Join<TLeft, TRight, TLeftDuration, TRightDuration, TResult>._>
    {
        ...
        public Join(IRefObservable<TLeft> left, IRefObservable<TRight> right, Func<TLeft, IRefObservable<TLeftDuration>> leftDurationSelector, Func<TRight, IRefObservable<TRightDuration>> rightDurationSelector, Func<TLeft, TRight, TResult> resultSelector)
        {
            _left = left;
            _right = right;
        ...
        internal sealed class _ : IdentitySink<TResult>
        {
            ...
            public _(Join<TLeft, TRight, TLeftDuration, TRightDuration, TResult> parent, IRefObserver<TResult> observer)
                : base(observer)
            {
