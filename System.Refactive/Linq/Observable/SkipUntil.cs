...
namespace System.Refactive.Linq
{
    internal sealed class SkipUntil<TSource, TOther> : Producer<TSource, SkipUntil<TSource, TOther>._>
    {
        ...
        private readonly IRefObservable<TOther> _other;

        public SkipUntil(IRefObservable<TSource> source, IRefObservable<TOther> other)
        {
            _source = source;
            _other = other;
        }
        ...
        internal sealed class _ : IdentitySink<TSource>
        {
            ...
            private sealed class OtherObserver : IRefObserver<TOther>, IDisposable
            {
                ...
                public void OnNext(ref TOther value)
                {
    ...
    internal sealed class SkipUntil<TSource> : Producer<TSource, SkipUntil<TSource>._>
    {
        ...
        public SkipUntil(IRefObservable<TSource> source, DateTimeOffset startTime, IScheduler scheduler)
        {
            _source = source;
        ...
        public IRefObservable<TSource> Combine(DateTimeOffset startTime)
        {
            //
            // Maximum semantics:
            //
