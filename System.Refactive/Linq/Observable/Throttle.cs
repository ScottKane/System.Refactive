...
namespace System.Refactive.Linq
{
    internal sealed class Throttle<TSource> : Producer<TSource, Throttle<TSource>._>
    {
        ...
        public Throttle(IRefObservable<TSource> source, TimeSpan dueTime, IScheduler scheduler)
        {
            _source = source;
            _dueTime = dueTime;
        ...
        internal sealed class _ : IdentitySink<TSource>
        {
            ...
            public _(Throttle<TSource> parent, IRefObserver<TSource> observer)
                : base(observer)
            {
    ...
    {
        private readonly IRefObservable<TSource> _source;
        private readonly Func<TSource, IRefObservable<TThrottle>> _throttleSelector;

        public Throttle(IRefObservable<TSource> source, Func<TSource, IRefObservable<TThrottle>> throttleSelector)
        {
            _source = source;
        ...
        internal sealed class _ : IdentitySink<TSource>
        {
            ...
            public _(Throttle<TSource, TThrottle> parent, IRefObserver<TSource> observer)
                : base(observer)
            {
            ...
            public override void OnNext(ref TSource value)
            {
                IRefObservable<TThrottle> throttle;
                try
                {
            ...
            private sealed class ThrottleObserver : SafeObserver<TThrottle>
            {
                ...
                public override void OnNext(ref TThrottle value)
                {
                    lock (_parent._gate)
                    {
