...
namespace System.Refactive.Linq
{
    internal sealed class MaxBy<TSource, TKey> : Producer<IList<TSource>, MaxBy<TSource, TKey>._>
    {
        ...
        public MaxBy(IRefObservable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer)
        {
            _source = source;
        ...
        internal sealed class _ : Sink<TSource, IList<TSource>>
        {
            ...
            public _(MaxBy<TSource, TKey> parent, IRefObserver<IList<TSource>> observer)
                : base(observer)
            {
