...
namespace System.Refactive.Linq
{
    internal sealed class Sample<TSource, TSample> : Producer<TSource, Sample<TSource, TSample>._>
    {
        ...
        private readonly IRefObservable<TSample> _sampler;

        public Sample(IRefObservable<TSource> source, IRefObservable<TSample> sampler)
        {
            _source = source;
            _sampler = sampler;
        }
        ...
        internal sealed class _ : IdentitySink<TSource>
        {
            ...
            private sealed class SampleObserver : IRefObserver<TSample>
            {
                ...
                public void OnNext(ref TSample value)
                {
                    lock (_parent._gate)
                    {
                        if (_parent._hasValue)
                        {
                            ...
                            _parent.ForwardOnNext(ref _parent._value!);
                        }
    ...
    internal sealed class Sample<TSource> : Producer<TSource, Sample<TSource>._>
    {
        ...
        public Sample(IRefObservable<TSource> source, TimeSpan interval, IScheduler scheduler)
        {
            _source = source;
            _interval = interval;
