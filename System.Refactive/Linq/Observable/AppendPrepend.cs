...
namespace System.Refactive.Linq
{
    ...
    {
        internal interface IAppendPrepend : IRefObservable<TSource>
        {
            ...
            where TSink : IDisposable
        {
            ...
            public SingleBase(IRefObservable<TSource> source, TSource value, bool append)
            {
                _source = source;
                _value = value;
                _append = append;
        ...
        internal sealed class SingleValue : SingleBase<SingleValue._>
        {
            ...
            public SingleValue(IRefObservable<TSource> source, TSource value, IScheduler scheduler, bool append)
            ...
            internal sealed class _ : IdentitySink<TSource>
            {
                ...
                public _(SingleValue parent, IRefObserver<TSource> observer)
                    : base(observer)
                {
                ...
                {
                    sink.ForwardOnNext(ref sink._value);
        ...
        private sealed class Recursive : Producer<TSource, Recursive._>, IAppendPrepend
        {
            ...
            public Recursive(IRefObservable<TSource> source, Node<TSource>? prepends, Node<TSource>? appends, IScheduler scheduler)
            {
                _source = source;
                _appends = appends;
                _prepends = prepends;
            ...
            internal sealed class _ : IdentitySink<TSource>
            {
                ...
                public _(Recursive parent, IRefObserver<TSource> observer)
                    : base(observer)
                {
                    _source = parent._source;
                    _scheduler = parent.Scheduler;
        ...
        private sealed class LongRunning : Producer<TSource, LongRunning._>, IAppendPrepend
        {
            ...
            public LongRunning(IRefObservable<TSource> source, Node<TSource>? prepends, Node<TSource>? appends, IScheduler scheduler, ISchedulerLongRunning longRunningScheduler)
            {
                _source = source;
                _appends = appends;
                _prepends = prepends;
            ...
            internal sealed class _ : IdentitySink<TSource>
            {
                ...
                public _(LongRunning parent, IRefObserver<TSource> observer)
                    : base(observer)
                {
                    _source = parent._source;
                ...
                private void PrependValues(ICancelable cancel)
                {
                    ...
                    {
                        ForwardOnNext(ref Unsafe.AsRef(current.Value));
        ...
        internal sealed class SingleImmediate : SingleBase<SingleImmediate._>
        {
            ...
            public SingleImmediate(IRefObservable<TSource> source, TSource value, bool append)
                : base(source, value, append)
            {
            }
            ...
            internal sealed class _ : IdentitySink<TSource>
            {
                ...
                public _(SingleImmediate parent, IRefObserver<TSource> observer)
                    : base(observer)
                {
                    _source = parent._source;
                    _value = parent._value;
