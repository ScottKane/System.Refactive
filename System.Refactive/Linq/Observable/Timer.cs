    ...
    internal static class Timer
    {
        internal abstract class Single : Producer<long, Single._>
        {
            ...
            internal sealed class _ : IdentitySink<long>
            {
                ...
                private void Invoke()
                {
                    ForwardOnNext(ref Unsafe.AsRef<long>(0));
                    ForwardOnCompleted();
                }
            }
        }
        ...
        internal abstract class Periodic : Producer<long, Periodic._>
        {
            ...
            internal sealed class Relative : Periodic
            {
                ...
                protected override _ CreateSink(IRefObserver<long> observer) => new _(_period, observer);
            ...
            internal sealed class _ : IdentitySink<long>
            {
                ...
                public _(TimeSpan period, IRefObserver<long> observer)
                    : base(observer)
                {
                    _period = period;
                }
                ...
                private IDisposable InvokeStart(IScheduler self)
                {
                    ...
                    try
                    {
                        ForwardOnNext(ref Unsafe.AsRef(0L));
                    }
                    catch (Exception e)
                    {
                        d.Dispose();
