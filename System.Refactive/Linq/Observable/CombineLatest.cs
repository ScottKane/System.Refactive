...
namespace System.Refactive.Linq
{
    ...
    internal sealed class CombineLatest<TFirst, TSecond, TResult> : Producer<TResult, CombineLatest<TFirst, TSecond, TResult>._>
    {
        ...
        public CombineLatest(IRefObservable<TFirst> first, IRefObservable<TSecond> second, Func<TFirst, TSecond, TResult> resultSelector)
        {
            _first = first;
            _second = second;
    ...
    internal abstract class CombineLatestSink<TResult> : IdentitySink<TResult>, ICombineLatest
    {
        ...
        protected CombineLatestSink(int arity, IRefObserver<TResult> observer)
            : base(observer)
        {
            _gate = new object();
    ...
    internal sealed class CombineLatest<TSource, TResult> : Producer<TResult, CombineLatest<TSource, TResult>._>
    {
        ...
        public CombineLatest(IEnumerable<IRefObservable<TSource>> sources, Func<IList<TSource>, TResult> resultSelector)
        {
            _sources = sources;
            _resultSelector = resultSelector;
        }
        ...
        internal sealed class _ : IdentitySink<TResult>
        {
            ...
            public _(Func<IList<TSource>, TResult> resultSelector, IRefObserver<TResult> observer)
                : base(observer)
            {
                _resultSelector = resultSelector;
