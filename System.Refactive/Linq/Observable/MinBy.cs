...
namespace System.Refactive.Linq
{
    internal sealed class MinBy<TSource, TKey> : Producer<IList<TSource>, MinBy<TSource, TKey>._>
    {
        ...
        public MinBy(IRefObservable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer)
        {
            _source = source;
        ...
        internal sealed class _ : Sink<TSource, IList<TSource>>
        {
            ...
            public _(MinBy<TSource, TKey> parent, IRefObserver<IList<TSource>> observer)
                : base(observer)
            {
