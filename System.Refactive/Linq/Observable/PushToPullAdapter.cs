...
namespace System.Refactive.Linq
{
    internal abstract class PushToPullAdapter<TSource, TResult> : IEnumerable<TResult>
    {
        ...
        protected PushToPullAdapter(IRefObservable<TSource> source)
        {
            _source = source;
        }
    ...
    internal abstract class PushToPullSink<TSource, TResult> : IRefObserver<TSource>, IEnumerator<TResult>
    {
