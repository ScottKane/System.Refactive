...
namespace System.Refactive.Linq
{
    internal sealed class Distinct<TSource, TKey> : Producer<TSource, Distinct<TSource, TKey>._>
    {
        ...
        public Distinct(IRefObservable<TSource> source, Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer)
        {
            _source = source;
        ...
        internal sealed class _ : IdentitySink<TSource>
        {
            ...
            public _(Distinct<TSource, TKey> parent, IRefObserver<TSource> observer)
                : base(observer)
            {
