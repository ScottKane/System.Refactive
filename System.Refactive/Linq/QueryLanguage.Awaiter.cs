...
namespace System.Refactive.Linq
{
    ...
    {
        public virtual AsyncSubject<TSource> GetAwaiter<TSource>(IRefObservable<TSource> source)
        {
        ...
        public virtual AsyncSubject<TSource> RunAsync<TSource>(IRefObservable<TSource> source, CancellationToken cancellationToken)
        {
        ...
        private static void RegisterCancelation<T>(AsyncSubject<T> subject, IDisposable subscription, CancellationToken token)
        {
            ...
            //
            subject.Subscribe(Stubs<T>.RefIgnore, _ => ctr.Dispose(), ctr.Dispose);
        }
    }
}
