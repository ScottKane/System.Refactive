...
namespace System.Refactive.Linq
{
    public static partial class Observable
    {
        ...
        public static IEnumerable<IList<TSource>> Chunkify<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
        ...
        public static IEnumerable<TResult> Collect<TSource, TResult>(this IRefObservable<TSource> source, Func<TResult> newCollector, Func<TResult, TSource, TResult> merge)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IEnumerable<TResult> Collect<TSource, TResult>(this IRefObservable<TSource> source, Func<TResult> getInitialCollector, Func<TResult, TSource, TResult> merge, Func<TResult, TResult> getNewCollector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <seealso cref="Observable.FirstAsync{TSource}(IRefObservable{TSource})"/>
        [Obsolete(Constants_Linq.UseAsync)]
        public static TSource First<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <seealso cref="Observable.FirstAsync{TSource}(IRefObservable{TSource}, Func{TSource, bool})"/>
        [Obsolete(Constants_Linq.UseAsync)]
        public static TSource First<TSource>(this IRefObservable<TSource> source, Func<TSource, bool> predicate)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        /// <seealso cref="Observable.FirstOrDefaultAsync{TSource}(IRefObservable{TSource})"/>
        [Obsolete(Constants_Linq.UseAsync)]
        [return: MaybeNull]
        public static TSource FirstOrDefault<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="predicate"/> is null.</exception>
        /// <seealso cref="Observable.FirstOrDefaultAsync{TSource}(IRefObservable{TSource}, Func{TSource, bool})"/>
        [Obsolete(Constants_Linq.UseAsync)]
        [return: MaybeNull]
        public static TSource FirstOrDefault<TSource>(this IRefObservable<TSource> source, Func<TSource, bool> predicate)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        [Obsolete(Constants_Linq.UseAsync)]
        public static void ForEach<TSource>(this IRefObservable<TSource> source, Action<TSource> onNext)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <remarks>Because of its blocking nature, this operator is mainly used for testing.</remarks>
        [Obsolete(Constants_Linq.UseAsync)]
        public static void ForEach<TSource>(this IRefObservable<TSource> source, Action<TSource, int> onNext)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        public static IEnumerator<TSource> GetEnumerator<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        /// <exception cref="InvalidOperationException">The source sequence is empty.</exception>
        /// <seealso cref="Observable.LastAsync{TSource}(IRefObservable{TSource})"/>
        [Obsolete(Constants_Linq.UseAsync)]
        public static TSource Last<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="predicate"/> is null.</exception>
        /// <exception cref="InvalidOperationException">No element satisfies the condition in the predicate. -or- The source sequence is empty.</exception>
        /// <seealso cref="Observable.LastAsync{TSource}(IRefObservable{TSource}, Func{TSource, bool})"/>
        [Obsolete(Constants_Linq.UseAsync)]
        public static TSource Last<TSource>(this IRefObservable<TSource> source, Func<TSource, bool> predicate)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        /// <seealso cref="Observable.LastOrDefaultAsync{TSource}(IRefObservable{TSource})"/>
        [Obsolete(Constants_Linq.UseAsync)]
        [return: MaybeNull]
        public static TSource LastOrDefault<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="predicate"/> is null.</exception>
        /// <seealso cref="Observable.LastOrDefaultAsync{TSource}(IRefObservable{TSource}, Func{TSource, bool})"/>
        [Obsolete(Constants_Linq.UseAsync)]
        [return: MaybeNull]
        public static TSource LastOrDefault<TSource>(this IRefObservable<TSource> source, Func<TSource, bool> predicate)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IEnumerable<TSource> Latest<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        public static IEnumerable<TSource> MostRecent<TSource>(this IRefObservable<TSource> source, TSource initialValue)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        public static IEnumerable<TSource> Next<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <seealso cref="Observable.SingleAsync{TSource}(IRefObservable{TSource})"/>
        [Obsolete(Constants_Linq.UseAsync)]
        public static TSource Single<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <seealso cref="Observable.SingleAsync{TSource}(IRefObservable{TSource}, Func{TSource, bool})"/>
        [Obsolete(Constants_Linq.UseAsync)]
        public static TSource Single<TSource>(this IRefObservable<TSource> source, Func<TSource, bool> predicate)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <seealso cref="Observable.SingleOrDefaultAsync{TSource}(IRefObservable{TSource})"/>
        [Obsolete(Constants_Linq.UseAsync)]
        [return: MaybeNull]
        public static TSource SingleOrDefault<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <seealso cref="Observable.SingleOrDefaultAsync{TSource}(IRefObservable{TSource}, Func{TSource, bool})"/>
        [Obsolete(Constants_Linq.UseAsync)]
        [return: MaybeNull]
        public static TSource SingleOrDefault<TSource>(this IRefObservable<TSource> source, Func<TSource, bool> predicate)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
        /// <exception cref="InvalidOperationException">The source sequence is empty.</exception>
        public static TSource Wait<TSource>(this IRefObservable<TSource> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
