...
namespace System.Refactive.Linq
{
    public static partial class Observable
    {
        ...
        public static Task ForEachAsync<TSource>(this IRefObservable<TSource> source, Action<TSource> onNext)
        {
            if (source == null)
            {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="onNext"/> is null.</exception>
        /// <remarks>This operator is especially useful in conjunction with the asynchronous programming features introduced in C# 5.0 and Visual Basic 11.</remarks>
        public static Task ForEachAsync<TSource>(this IRefObservable<TSource> source, Action<TSource> onNext, CancellationToken cancellationToken)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="onNext"/> is null.</exception>
        /// <remarks>This operator is especially useful in conjunction with the asynchronous programming features introduced in C# 5.0 and Visual Basic 11.</remarks>
        public static Task ForEachAsync<TSource>(this IRefObservable<TSource> source, Action<TSource, int> onNext)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="onNext"/> is null.</exception>
        /// <remarks>This operator is especially useful in conjunction with the asynchronous programming features introduced in C# 5.0 and Visual Basic 11.</remarks>
        public static Task ForEachAsync<TSource>(this IRefObservable<TSource> source, Action<TSource, int> onNext, CancellationToken cancellationToken)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TResult> Case<TValue, TResult>(Func<TValue> selector, IDictionary<TValue, IRefObservable<TResult>> sources, IRefObservable<TResult> defaultSource)
        ...
        public static IRefObservable<TResult> Case<TValue, TResult>(Func<TValue> selector, IDictionary<TValue, IRefObservable<TResult>> sources, IScheduler scheduler)
            where TValue : notnull
        {
            if (selector == null)
            {
        ...
        public static IRefObservable<TResult> Case<TValue, TResult>(Func<TValue> selector, IDictionary<TValue, IRefObservable<TResult>> sources)
            where TValue : notnull
        {
            if (selector == null)
            {
        ...
        public static IRefObservable<TSource> DoWhile<TSource>(this IRefObservable<TSource> source, Func<bool> condition)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TResult> For<TSource, TResult>(IEnumerable<TSource> source, Func<TSource, IRefObservable<TResult>> resultSelector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TResult> If<TResult>(Func<bool> condition, IRefObservable<TResult> thenSource, IRefObservable<TResult> elseSource)
        {
            if (condition == null)
            {
                throw new ArgumentNullException(nameof(condition));
        ...
        public static IRefObservable<TResult> If<TResult>(Func<bool> condition, IRefObservable<TResult> thenSource)
        {
            if (condition == null)
            {
                throw new ArgumentNullException(nameof(condition));
        ...
        public static IRefObservable<TResult> If<TResult>(Func<bool> condition, IRefObservable<TResult> thenSource, IScheduler scheduler)
        {
            if (condition == null)
            {
                throw new ArgumentNullException(nameof(condition));
        ...
        public static IRefObservable<TSource> While<TSource>(Func<bool> condition, IRefObservable<TSource> source)
        {
            if (condition == null)
            {
                throw new ArgumentNullException(nameof(condition));
