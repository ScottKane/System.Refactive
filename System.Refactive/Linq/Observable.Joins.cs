...
namespace System.Refactive.Linq
{
    public static partial class Observable
    {
        ...
        public static Pattern<TLeft, TRight> And<TLeft, TRight>(this IRefObservable<TLeft> left, IRefObservable<TRight> right)
        {
            if (left == null)
            {
        ...
        public static Plan<TResult> Then<TSource, TResult>(this IRefObservable<TSource> source, Func<TSource, TResult> selector)
        {
            if (source == null)
            {
        ...
        public static IRefObservable<TResult> When<TResult>(params Plan<TResult>[] plans)
        {
            if (plans == null)
            {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="plans"/> is null.</exception>
        public static IRefObservable<TResult> When<TResult>(this IEnumerable<Plan<TResult>> plans)
        {
            if (plans == null)
            {
                throw new ArgumentNullException(nameof(plans));
