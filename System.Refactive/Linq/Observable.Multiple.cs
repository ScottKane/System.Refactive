...
namespace System.Refactive.Linq
{
    public static partial class Observable
    {
        ...
        public static IRefObservable<TSource> Amb<TSource>(this IRefObservable<TSource> first, IRefObservable<TSource> second)
        {
            if (first == null)
            {
        ...
        [Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Amb", Justification = "In honor of McCarthy.")]
        public static IRefObservable<TSource> Amb<TSource>(params IRefObservable<TSource>[] sources)
        {
            if (sources == null)
            {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        [Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Amb", Justification = "In honor of McCarthy.")]
        public static IRefObservable<TSource> Amb<TSource>(this IEnumerable<IRefObservable<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        public static IRefObservable<IList<TSource>> Buffer<TSource, TBufferClosing>(this IRefObservable<TSource> source, Func<IRefObservable<TBufferClosing>> bufferClosingSelector)
        {
            if (source == null)
            {
        ...
        public static IRefObservable<IList<TSource>> Buffer<TSource, TBufferOpening, TBufferClosing>(this IRefObservable<TSource> source, IRefObservable<TBufferOpening> bufferOpenings, Func<TBufferOpening, IRefObservable<TBufferClosing>> bufferClosingSelector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<IList<TSource>> Buffer<TSource, TBufferBoundary>(this IRefObservable<TSource> source, IRefObservable<TBufferBoundary> bufferBoundaries)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TSource> Catch<TSource, TException>(this IRefObservable<TSource> source, Func<TException, IRefObservable<TSource>> handler) where TException : Exception
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="first"/> or <paramref name="second"/> is null.</exception>
        public static IRefObservable<TSource> Catch<TSource>(this IRefObservable<TSource> first, IRefObservable<TSource> second)
        {
            if (first == null)
            {
                throw new ArgumentNullException(nameof(first));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        public static IRefObservable<TSource> Catch<TSource>(params IRefObservable<TSource>[] sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <returns>An observable sequence containing elements from consecutive source sequences until a source sequence terminates successfully.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        public static IRefObservable<TSource> Catch<TSource>(this IEnumerable<IRefObservable<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        public static IRefObservable<TResult> CombineLatest<TSource1, TSource2, TResult>(this IRefObservable<TSource1> first, IRefObservable<TSource2> second, Func<TSource1, TSource2, TResult> resultSelector)
        {
            if (first == null)
            {
                throw new ArgumentNullException(nameof(first));
        ...
        /// <remarks>If a non-empty source completes, its very last value will be used for creating subsequent combinations until all sources terminate.</remarks>
        public static IRefObservable<TResult> CombineLatest<TSource, TResult>(this IEnumerable<IRefObservable<TSource>> sources, Func<IList<TSource>, TResult> resultSelector)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        /// <remarks>If a non-empty source completes, its very last value will be used for creating subsequent combinations until all sources terminate.</remarks>
        public static IRefObservable<List<TSource>> CombineLatest<TSource>(this IEnumerable<IRefObservable<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        /// <remarks>If a non-empty source completes, its very last value will be used for creating subsequent combinations until all sources terminate.</remarks>
        public static IRefObservable<List<TSource>> CombineLatest<TSource>(params IRefObservable<TSource>[] sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="first"/> or <paramref name="second"/> is null.</exception>
        public static IRefObservable<TSource> Concat<TSource>(this IRefObservable<TSource> first, IRefObservable<TSource> second)
        {
            if (first == null)
            {
                throw new ArgumentNullException(nameof(first));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        public static IRefObservable<TSource> Concat<TSource>(params IRefObservable<TSource>[] sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <returns>An observable sequence that contains the elements of each given sequence, in sequential order.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        public static IRefObservable<TSource> Concat<TSource>(this IEnumerable<IRefObservable<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        public static IRefObservable<TSource> Concat<TSource>(this IRefObservable<IRefObservable<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        /// <remarks>If the tasks support cancellation, consider manual conversion of the tasks using <see cref="Observable.FromAsync{TSource}(Func{CancellationToken, Task{TSource}})"/>, followed by a concatenation operation using <see cref="Observable.Concat{TSource}(IRefObservable{IRefObservable{TSource}})"/>.</remarks>
        public static IRefObservable<TSource> Concat<TSource>(this IRefObservable<Task<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        public static IRefObservable<TSource> Merge<TSource>(this IRefObservable<IRefObservable<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        /// <remarks>If the tasks support cancellation, consider manual conversion of the tasks using <see cref="Observable.FromAsync{TSource}(Func{CancellationToken, Task{TSource}})"/>, followed by a merge operation using <see cref="Observable.Merge{TSource}(IRefObservable{IRefObservable{TSource}})"/>.</remarks>
        public static IRefObservable<TSource> Merge<TSource>(this IRefObservable<Task<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        public static IRefObservable<TSource> Merge<TSource>(this IRefObservable<IRefObservable<TSource>> sources, int maxConcurrent)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="maxConcurrent"/> is less than or equal to zero.</exception>
        public static IRefObservable<TSource> Merge<TSource>(this IEnumerable<IRefObservable<TSource>> sources, int maxConcurrent)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="maxConcurrent"/> is less than or equal to zero.</exception>
        public static IRefObservable<TSource> Merge<TSource>(this IEnumerable<IRefObservable<TSource>> sources, int maxConcurrent, IScheduler scheduler)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="first"/> or <paramref name="second"/> is null.</exception>
        public static IRefObservable<TSource> Merge<TSource>(this IRefObservable<TSource> first, IRefObservable<TSource> second)
        {
            if (first == null)
            {
                throw new ArgumentNullException(nameof(first));
        ...
        public static IRefObservable<TSource> Merge<TSource>(this IRefObservable<TSource> first, IRefObservable<TSource> second, IScheduler scheduler)
        {
            if (first == null)
            {
                throw new ArgumentNullException(nameof(first));
        ...
        /// <returns>The observable sequence that merges the elements of the observable sequences.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        public static IRefObservable<TSource> Merge<TSource>(params IRefObservable<TSource>[] sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        public static IRefObservable<TSource> Merge<TSource>(IScheduler scheduler, params IRefObservable<TSource>[] sources)
        {
            if (scheduler == null)
            {
                throw new ArgumentNullException(nameof(scheduler));
        ...
        /// <returns>The observable sequence that merges the elements of the observable sequences.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        public static IRefObservable<TSource> Merge<TSource>(this IEnumerable<IRefObservable<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <returns>The observable sequence that merges the elements of the observable sequences.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> or <paramref name="scheduler"/> is null.</exception>
        public static IRefObservable<TSource> Merge<TSource>(this IEnumerable<IRefObservable<TSource>> sources, IScheduler scheduler)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="first"/> or <paramref name="second"/> is null.</exception>
        public static IRefObservable<TSource> OnErrorResumeNext<TSource>(this IRefObservable<TSource> first, IRefObservable<TSource> second)
        {
            if (first == null)
            {
                throw new ArgumentNullException(nameof(first));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        public static IRefObservable<TSource> OnErrorResumeNext<TSource>(params IRefObservable<TSource>[] sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <returns>An observable sequence that concatenates the source sequences, even if a sequence terminates exceptionally.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        public static IRefObservable<TSource> OnErrorResumeNext<TSource>(this IEnumerable<IRefObservable<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        public static IRefObservable<TSource> SkipUntil<TSource, TOther>(this IRefObservable<TSource> source, IRefObservable<TOther> other)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        public static IRefObservable<TSource> Switch<TSource>(this IRefObservable<IRefObservable<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        /// <remarks>If the tasks support cancellation, consider manual conversion of the tasks using <see cref="Observable.FromAsync{TSource}(Func{CancellationToken, Task{TSource}})"/>, followed by a switch operation using <see cref="Observable.Switch{TSource}(IRefObservable{IRefObservable{TSource}})"/>.</remarks>
        public static IRefObservable<TSource> Switch<TSource>(this IRefObservable<Task<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="other"/> is null.</exception>
        public static IRefObservable<TSource> TakeUntil<TSource, TOther>(this IRefObservable<TSource> source, IRefObservable<TOther> other)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<TSource> TakeUntil<TSource>(this IRefObservable<TSource> source, Func<TSource, bool> stopPredicate)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<IRefObservable<TSource>> Window<TSource, TWindowClosing>(this IRefObservable<TSource> source, Func<IRefObservable<TWindowClosing>> windowClosingSelector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<IRefObservable<TSource>> Window<TSource, TWindowOpening, TWindowClosing>(this IRefObservable<TSource> source, IRefObservable<TWindowOpening> windowOpenings, Func<TWindowOpening, IRefObservable<TWindowClosing>> windowClosingSelector)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        public static IRefObservable<IRefObservable<TSource>> Window<TSource, TWindowBoundary>(this IRefObservable<TSource> source, IRefObservable<TWindowBoundary> windowBoundaries)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="first"/> or <paramref name="second"/> or <paramref name="resultSelector"/> is null.</exception>
        public static IRefObservable<TResult> WithLatestFrom<TFirst, TSecond, TResult>(this IRefObservable<TFirst> first, IRefObservable<TSecond> second, Func<TFirst, TSecond, TResult> resultSelector)
        {
            if (first == null)
            {
                throw new ArgumentNullException(nameof(first));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="first"/> or <paramref name="second"/> or <paramref name="resultSelector"/> is null.</exception>
        public static IRefObservable<TResult> Zip<TSource1, TSource2, TResult>(this IRefObservable<TSource1> first, IRefObservable<TSource2> second, Func<TSource1, TSource2, TResult> resultSelector)
        {
            if (first == null)
            {
                throw new ArgumentNullException(nameof(first));
        ...
        /// <returns>An observable sequence containing the result of combining elements of the sources using the specified result selector function.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> or <paramref name="resultSelector"/> is null.</exception>
        public static IRefObservable<TResult> Zip<TSource, TResult>(this IEnumerable<IRefObservable<TSource>> sources, Func<IList<TSource>, TResult> resultSelector)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        public static IRefObservable<IList<TSource>> Zip<TSource>(this IEnumerable<IRefObservable<TSource>> sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <returns>An observable sequence containing lists of elements at corresponding indexes.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="sources"/> is null.</exception>
        public static IRefObservable<IList<TSource>> Zip<TSource>(params IRefObservable<TSource>[] sources)
        {
            if (sources == null)
            {
                throw new ArgumentNullException(nameof(sources));
        ...
        /// <returns>An observable sequence containing the result of pairwise combining the elements of the first and second source using the specified result selector function.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="first"/> or <paramref name="second"/> or <paramref name="resultSelector"/> is null.</exception>
        public static IRefObservable<TResult> Zip<TSource1, TSource2, TResult>(this IRefObservable<TSource1> first, IEnumerable<TSource2> second, Func<TSource1, TSource2, TResult> resultSelector)
        {
            if (first == null)
            {
                throw new ArgumentNullException(nameof(first));
    ...
    public static partial class ObservableEx
    {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="first"/> or <paramref name="second"/> is null.</exception>
        public static IRefObservable<(TFirst First, TSecond Second)> WithLatestFrom<TFirst, TSecond>(this IRefObservable<TFirst> first, IRefObservable<TSecond> second)
        {
            if (first == null)
            {
                throw new ArgumentNullException(nameof(first));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="first"/> or <paramref name="second"/> is null.</exception>
        public static IRefObservable<(TFirst First, TSecond Second)> Zip<TFirst, TSecond>(this IRefObservable<TFirst> first, IEnumerable<TSecond> second)
        {
            if (first == null)
            {
                throw new ArgumentNullException(nameof(first));
